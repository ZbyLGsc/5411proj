...
//----------------------------------------------------------------------------------------------
{
	...
	bool shadowTime = false;
        ...
        for (int bounces = 0; bounces < BOUNCE_NUM; bounces++)
	{
		...
		if (intersec.type == REFRSEA)  // Ideal dielectric REFRACTION
		{
			checkOcean = false;
	...
	} // end for (int bounces = 0; bounces < BOUNCE_NUM; bounces++)
...
//-----------------------------------------------------------------------
{
	...
	quads[0] = Quad( vec3(  -1000, -10.0,-100), vec3(1000, -10.0,-100), vec3(1000, 300.0, -3000), vec3(  -1000, 300.0,-3000),    z, vec3(0.7, 0.9,0.0),  DIFF);// bottom
	quads[1] = Quad( vec3(  -1000, -10.0, -3000), vec3(1000, -10.0,-3000), vec3(1000, 500.0, -3000), vec3( -1000, 500.0,-3000),    z, vec3(0.7, 0.12,0.05),  DIFF);// back
	...
	cones[2] = Cone( vec3(600,400,-2700), 150.0, vec3(600,280,-2700), 0.0, z, vec3(0.5,0.01,0.5), COAT);//blue Cone
